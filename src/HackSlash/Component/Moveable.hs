{-| 'Moveable' requires that an 'Entity' have a 'Transform' and 'Velocity'
    registered to execute.
 -}
...
-- | Moves the 'Entity' based on Velocity and Z direction determined by rotation.
runMoveable :: DeltaTime
            -> Maybe Velocity
            -> Maybe Transform
            -> Maybe (Velocity, Transform)
